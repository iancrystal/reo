...
class AgentsControllerTest < ActionController::TestCase
  ...
  test "should get edit if agent logged in but no member_status field" do
  ...
  test "should get edit if admin logged in has member_status field" do
  ...
  test "should update agent if logged in" do
  ...
  test "should not update agent if not logged in" do
  ...
  test "should not update membership status if not admin" do
  ...
  test "should destroy agent if logged in" do
  ...
  test "should not destroy agent if not logged in" do
